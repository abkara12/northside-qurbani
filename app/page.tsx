      ...
      <section className="mx-auto max-w-7xl px-6 pb-18 pt-3 sm:px-10 lg:pb-24 lg:pt-6">
        <div className="grid items-center gap-8 lg:grid-cols-12 xl:gap-10">
          <div className="text-center lg:col-span-7 lg:text-left">
            ...
            <h1 className="mt-5 bg-[linear-gradient(135deg,#fbf4e8_0%,#d8b67e_44%,#ffffff_100%)] bg-clip-text text-[2.55rem] font-semibold leading-[1.3] tracking-[-0.06em] text-transparent sm:text-[3.35rem] lg:text-[4.25rem] xl:text-[5rem]">
